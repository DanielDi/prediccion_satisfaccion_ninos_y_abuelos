...
Según la tabla anterior las variables que preguntan directamente por la salud no son respondidas por los niños, por lo tanto se decide desarrollar modelos por separado para los niños y los abuelos. 
## Gráfica
...
```{r,echo=F}
per_lim<-personas %>% select(-ID_Persona,-Clasificación,-SEXO) %>% na.omit() 
M = cor(per_lim)
