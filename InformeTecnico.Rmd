...
Para los abuelos, al igual que con los niños, se penso inicialmente en tomar un rango de edad que tomara la definicion popular de este colectivo, los adultos de la tercera edad (mayores de 60 años). Sin embargo, luego planteamos que debiamos tener en cuenta cual es la definicion literal de abuelo,  y mediante un sistema de grafos logramos determinar el numero de hombres y mujeres que tenian un nieto. Filtrándolos por su rango edad se observo que se tienen registrados un total de 1467 abuelos mayores de 60 años, y 1049 abuelos menores de 60 años.

<<<<<<< HEAD
Filtrandolos por su rango edad se observo que se tienen registrados un total de 1467 abuelos mayores de 60 años, y 1049 abuelos menores de 60 años.
...
Ante esta situación tomamos la desicion de tomar solamente a las personas de la tercera edad para nuestro modelo.
...
* COND_VIDA_DEL_HOGAR
=======
Se observa que con la definicion inicial estábamos omitiendo un total de 1049 observaciones, además, se observa que los abuelos registrados en la base de datos son relativamente pocos.
>>>>>>> ab3af27a4633d0417dc37c4cb36bf02cb6f5d2bb

Ante esta situación tomamos la decisión de tomar solamente a las personas de la tercera edad para nuestro modelo.
...
```{r, echo = F}
png(file = "App/www/decision_tree_niños.png", width = 6000, height = 3000, )
plot(ctreeNiños)
dev.off()
ctreeNiños
```
