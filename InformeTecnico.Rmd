...
df_trabajo <- merge(x = df_trabajo, y = datos_vivienda, by = "DIRECTORIO")
...
# Selecciona las variables de interés
df_trabajo <- subset(df_trabajo, select = c("P1898", "P5502", "P6020", "P8520S1A1", 
                                        "P8624", "P415", "P9010", "P9030"))
df_trabajo <- na.omit(df_trabajo)

# Cambia los nombres de las columnas
names(df_trabajo) = c("SATISFACCION", "ESTADO_CIVIL", "SEXO", "ESTRATO", "INGRESOS",
